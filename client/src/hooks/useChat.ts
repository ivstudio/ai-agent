...
/**
 * useChatStream - A React hook for handling AI chat streaming responses.
 * - Optimized for performance (avoids unnecessary re-renders)
 * - Efficient handling HTTP streaming responses
 * - Supports message roles and real-time AI responses
 */
const useChat = ({
    apiUrl,
    headers = {},
